...
final class Version20240727131146 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_form (id INT NOT NULL, user_id_id INT DEFAULT NULL, question VARCHAR(255) DEFAULT NULL, answer TEXT DEFAULT NULL, PRIMARY KEY(id))');
